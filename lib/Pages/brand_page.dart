...
// import '../app/Widgets/flash_hot_deal_product_widget.dart';
...
class BrandPage extends StatefulWidget {
  ...
  const BrandPage({super.key, required this.category});
...
class _BrandPageState extends State<BrandPage> {
      ...
      setState(() {
        ...
        for (var element in value.docs) {
          setState(() {
            ...
            imageUrl = element['backgroundImage'];
          });
          // ignore: avoid_print
  ...
  getProducts() async {
    ...
    FirebaseFirestore.instance
        .collection('Products')
        // .limit(10)
        .where('brand', isEqualTo: widget.category)
        .snapshots()
        .listen((event) {
      setState(() {
        isLoaded = false;
