          ...
          return Dialog(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                double dialogWidth = constraints.maxWidth > 600 ? 600 : constraints.maxWidth * 0.8;
                double dialogHeight = constraints.maxWidth > 600 ? 600 : constraints.maxHeight * 0.5;
        ...
        child: Column(
          children: [
           ...
           const Gap(40),
            ...
            if (isWeb)
              Padding(
                padding: EdgeInsets.symmetric(horizontal: MediaQuery.of(context).size.width >= 1100 ? 32 : 16),
                child: Row(
                  children: [
                    Image.asset(
              ...
              Padding(
                ...
                child: GridView.builder(
                  ...
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: MediaQuery.of(context).size.width > 1100 ? 4 : 1,
                    crossAxisSpacing: 5,
                    mainAxisSpacing: 5,
        ...
        Wrap(
          ...
          children: const [
            TestimonialCard(
              ...
              feedback: 'Pelayanannya sangat bagus dan unit lelang update dan tampilan dari aplikasinya sangat user friendly',
                ...
                child: ExpansionTile(
                  ...
                  title: Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _expandedItems[index] ? Colors.blue : Colors.black87,
                    ),
                  ),
                  children: [
                    Padding(
...
class _VideoTutorialWidgetState extends State<VideoTutorialWidget> {
  ...
  void initState() {
    ...
    _controller = YoutubePlayerController(
      initialVideoId: 'AaU0c15cnjk', // Replace with your actual YouTube video ID
...
class FAQAndVideoWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isMobile = MediaQuery.of(context).size.width < 600;
    final isTablet = MediaQuery.of(context).size.width < 1100 && MediaQuery.of(context).size.width >= 600;
...
final List<FAQ> faqList = [
  ...
  FAQ(
    question: "Berapa lama waktu maksimal pelunasan untuk unit yang dimenangkan?",
    answer:
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Selamat Pagi Alvin, sedang mencari lelang apa?',
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Icon(
                icon,
                color: _selectedCategory == kategori ? Colors.white : Colors.black,
                size: 40,
              ),
              ...
              child: Row(
                children: [
                  _buildJadwalCard(
                    ...
                    jam: '13.00 WIB',
                    lokasi: 'MEDAN',
                    imageUrl: 'https://via.placeholder.com/150', // Ganti dengan URL gambar
                  ),
                  const SizedBox(width: 16),
                  _buildJadwalCard(
                    kategori: 'MOTOR',
  ...
  Widget _buildCategoryTab(String kategori, {bool isNew = false}) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: _selectedCategory == kategori ? Colors.green : Colors.transparent,
