...
class ProductByVendorPage extends StatefulWidget {
  final String category;
  const ProductByVendorPage({super.key, required this.category});

  @override
  State<ProductByVendorPage> createState() => _ProductByVendorPageState();
}

class _ProductByVendorPageState extends State<ProductByVendorPage> {
  ...
  @override
  void didUpdateWidget(covariant ProductByVendorPage oldWidget) {
    //  getSubCollections();
    getVendorDetail();
    getProducts();
    getCurrency();
                                                                    ...
                                                                    isLoaded ==
                                                                        ...
                                                                        : ListView.builder(
                                                                            ...
                                                                            itemBuilder: (context, index) {
                                                                              ...
                                                                              return ListTile(
                                                                                onTap: () {
                                                                                  context.go('/collection/${subCategoriesModel.name}');
                                                                                },
