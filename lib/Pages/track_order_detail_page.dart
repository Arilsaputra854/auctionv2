 ...
 Future<void> fetchOrderDetail() async {
    ...
    FirebaseFirestore.instance
      ...
      setState(() {
        ...
        quantity =
            orderModel!.orders.fold(0, (e, product) => e + product.quantity);
      });
    });
            ...
            child:
                Padding(
                  ...
                  steps: <Step>[
                    ...
                    Step(
                      isActive: orderModel!.acceptDelivery == true ? true : false,
                      title: const Text('Processing'),
                      content: Container(),
                    ),
                    Step(
                      isActive: orderModel!.status == 'Completed' ? true : false,
