...
import 'package:tunasauctionv2/Model/brand_model.dart';
...
class _BrandsWidgetState extends State<BrandsWidget> {
  ...
  getCats() {
    ...
    List<BrandModel> categories = [
      // BrandModel(category: "View All", image: '')
    ];
    return FirebaseFirestore.instance
      ...
      for (var element in value.docs) {
        setState(() {
          ...
          cats = categories;
          //  cats.add(BrandModel(category: "View All", image: ''));
        });
      }
    });
  }
                          ...
                          child: CarouselSlider.builder(
                            ...
                            itemBuilder:
                              ...
                              return InkWell(
                                ...
                                onTap: () {
                                  context.go('/brand/${brandModel.collection}');
                                },
                                child: BrandLogoWidget(brandModel: brandModel),
                              );
                            },
                          ),
                        ),
...
class _BrandLogoWidgetState extends State<BrandLogoWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () {
        context.go('/brand/${widget.brandModel.collection}');
      },
