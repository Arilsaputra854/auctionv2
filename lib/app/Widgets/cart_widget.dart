...
import 'package:tunasauctionv2/app/Widgets/quantity_button.dart';
...
class _CartWidgetState extends State<CartWidget> {
  ...
  getProducts() async {
    ...
    FirebaseFirestore.instance
      ...
      for (var element in event.docs) {
        ...
        setState(() {
          products.add(prods);
          quantity = products.fold(0, (u, product) => u + product.quantity);
          totalPrice = products.fold(0, (su, product) => su + product.price);
        });
      }
    });
  }
  ...
  Future<void> deleteCart(
    ...
    firestore
      ...
      setState(() {
        // carts.remove(id);
        quantity = products.fold(0, (r, product) => r + product.quantity);
      });
