              ...
              children: [
                ...
                if (MediaQuery.of(context).size.width <= 1100)
                  Image.asset(
                    ...
                    width: MediaQuery.of(context).size.width * 0.5, // Menggunakan 50% dari lebar layar
                    height: MediaQuery.of(context).size.height * 0.1, // Menggunakan 20% dari tinggi layar
                  ),
                const Gap(10),
                Align(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        shape: const CircleBorder(
                          side: BorderSide(color: Colors.red), // Tambahkan border merah
                        ),
                      ),
                      child: Image.asset('assets/image/google.png', height: 30), // Ganti dengan path gambar logo Google Anda
                    ),
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: const EdgeInsets.all(15),
                        shape: const CircleBorder(
                          side: BorderSide(color: Colors.blue), // Tambahkan border biru
                        ),
                      ),
                      child: Image.asset('assets/image/facebook.jpg', height: 30), // Ganti dengan path gambar logo Facebook Anda
                    ),
                    ...
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        padding: const EdgeInsets.all(15),
                        shape: const CircleBorder(
                          side: BorderSide(color: Colors.black), // Tambahkan border biru
                        ),
                      ),
                      child: Image.asset('assets/image/apple.jpg', height: 30), // Ganti dengan path gambar logo Facebook Anda
                    ),
