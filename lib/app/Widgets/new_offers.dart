...
class _NewOffersState extends State<NewOffers> {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: 450, // Memperbesar panjang container utama
      decoration: BoxDecoration(
        color: appColor, // Warna background #585858
      ),
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            isLoaded == true
                ? SizedBox(
              height: 450, // Memperbesar panjang shimmer effect
              ...
              child: Stack(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Image.asset(
                            'assets/image/timedauction.png', // Ganti dengan path gambar Anda
                      ...
                      // CarouselSlider
                      Expanded(
                        flex: 3, // Sesuaikan flex sesuai kebutuhan
                        child: SizedBox(
                          height: 370, // Memperbesar panjang CarouselSlider
                  ...
                  // Tombol navigasi CarouselSlider
