...
import 'package:tunasauctionv2/Model/history.dart';
import 'package:tunasauctionv2/Model/order_model.dart';
import 'package:tunasauctionv2/Pages/return_product_page.dart';
...
class _ResultState extends State<Result> {
  ...
  deleteOrder() {
    showModal(
        ...
        builder: (context) {
          return AlertDialog(
            content:
                const Text('Are you sure you want delete this order?'),
            actions: [
              TextButton(
                  onPressed: () {
                    ...
                    FirebaseFirestore.instance
                      ...
                      Fluttertoast.showToast(
                          msg: "Your order has been deleted",
  ...
  updateWallet() {
    ...
    FirebaseFirestore.instance
      ...
      // Fluttertoast.showToast(
      //         msg: "Wallet has been uploaded successfully",
      //         toastLength: Toast.LENGTH_SHORT,
      //         gravity: ToastGravity.TOP,
      //         timeInSecForIosWeb: 1,
      //         fontSize: 14.0)
  ...
  getRiderDetail() {
    if (widget.orderModel2.acceptDelivery == true ||
        widget.orderModel2.deliveryBoyID.isNotEmpty) {
      FirebaseFirestore.instance
          .collection('riders')
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
            ...
            return Padding(
              ...
              child: Container(
                ...
                height: MediaQuery.of(context).size.width >= 1100
                    ? widget.orderModel2.status == 'Completed'
                        ? 230
                        : 200
                    : widget.orderModel2.status == 'Completed'
                        ? 260
        ...
        if (widget.orderModel2.accept == false) const Gap(20),
        if (widget.orderModel2.accept == false)
          Center(
