          ...
          Align(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  if (MediaQuery.of(context).size.width <= 1100) const Text(''),
                  Text(
                    'Riwayat Lelang',
                    style: TextStyle(
          ...
          isLoading == true
              ...
              : orders.isEmpty
                  ? Column(
                      ...
                      children: [
                        Center(
                          child: Image.asset( // Ganti dengan Image.asset()
                            'assets/image/empty.jpg', // Path ke aset gambar
                        ...
                        const Gap(10),
                        const Text('Belum ada data transaksi pembelian'),
                        const Gap(20),
                      ],
                    )
                  : ListView.builder(
