...
class ProductsAllCatWidget extends StatefulWidget {
  final String cat;
  const ProductsAllCatWidget({super.key, required this.cat});

  @override
  State<ProductsAllCatWidget> createState() => _ProductsAllCatWidgetState();
}

class _ProductsAllCatWidgetState extends State<ProductsAllCatWidget> {
