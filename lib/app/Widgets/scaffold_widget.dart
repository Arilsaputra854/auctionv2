...
class _ScaffoldWidgetState extends State<ScaffoldWidget> {
  ...
  Widget build(BuildContext context) {
    print('ScaffoldWidget parameters - body: ${widget.body}, path: ${widget.path}');
      ...
      MediaQuery.of(context).size.width >= 1100
        ...
        onTap: (index) {
          if (index == 0) {
            ...
            context.go('/flash-sales'); // pastikan rute untuk jadwal lelang ada
            currentIndex = index;
          } else if (index == 3) {
            context.go('/live-auction-all'); // pastikan rute live auction ada
            currentIndex = index;
          }
          else if (index == 4) {
          ...
          Expanded(
            child: Scaffold(
              appBar: AppBar(
                ...
                toolbarHeight: MediaQuery.of(context).size.width >= 1100 ? 90 : null,
                leadingWidth: MediaQuery.of(context).size.width >= 1100 ? 350 : 200,
                ...
                bottom: loaded == true
                    ...
                    child: Material(
                        color: appColor, child: CatsTabs(data: categories)))
                    : const PreferredSize(
