        ...
        Expanded(
          ...
          child: TypeAheadField<ProductsModel>(
            ...
            onSelected: (ProductsModel value) {
              ...
              context.go('/product-detail/${value.uid}');
            },
          ),
        ),
                    ...
                    onPressed: () {
                      if (_controller.text.isEmpty) {
                        Fluttertoast.showToast(
                            msg: "Use the search field to continue",
                        ...
                        Fluttertoast.showToast(
                            msg: "Enter more details to continue",
                            toastLength: Toast.LENGTH_SHORT,
                            gravity: ToastGravity.TOP,
                            timeInSecForIosWeb: 2,
                            fontSize: 14.0);
                      } else {
                        context.go('/search/${_controller.text}');
                      }
                    },
                    child: const Text(
                      'Cari',
