...
class VendorWidgetMain extends StatefulWidget {
  final UserModel productsModel;
  final bool fromHome;
  const VendorWidgetMain(
      {super.key, required this.productsModel, required this.fromHome});

  @override
  State<VendorWidgetMain> createState() => _VendorWidgetMainState();
}

class _VendorWidgetMainState extends State<VendorWidgetMain> {
  String currency = '';
  @override
  void initState() {
    // getCurrency();
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  //     title: Text(
                  //       widget.productsModel.lokasi,
                  //     ),
                  //     // leading: const Icon(Icons.location),
                  //   ),
                  // if (widget.fromHome == false)
                  //   ListTile(
                  //     visualDensity: const VisualDensity(horizontal: 0, vertical: -2),
                  //     title: Text(
                  //       widget.productsModel.kendaraan,
                  //     ),
                  ...
                  //     visualDensity: const VisualDensity(horizontal: 0, vertical: -2),
                  //     title: Text(
                  //       widget.productsModel.lotproses,
                  //     ),
                  //     // leading: const Icon(Icons.phone),
                  //   ),
                  // if (widget.fromHome == false)
                  ...
                  //     visualDensity: const VisualDensity(horizontal: 0, vertical: -2),
                  //     title: Text(
                  //       widget.productsModel.lotbelumproses,
                  //     ),
                  //     // leading: const Icon(Icons.phone),
                  //   ),
                  // if (widget.fromHome == false)
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                        ...
                        onPressed: () {
                          context
                              .go('/vendor-detail/${widget.productsModel.id}');
                        },
                        icon: const Icon(
                          Icons.storefront,
                          color: Colors.white,
