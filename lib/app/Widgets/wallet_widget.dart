...
import 'package:tunasauctionv2/app/Widgets/flutterwave_web_widget.dart';
import 'package:tunasauctionv2/app/Widgets/paystack_web_widget.dart';
import 'package:tunasauctionv2/app/Widgets/transaction_history_widget.dart';
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('Upload money with Paystack payment gateway'),
            trailing: const Icon(Icons.chevron_right),
          ),
          const Gap(20),
          Padding(
