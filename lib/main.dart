...
bool isLogged = false;
getAuth(AuthService authService) {
    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        if (kIsWeb && snapshot.hasData) {
          ...
          meta.description(
              description: metaData['description'] ?? 'Tunas Auction');
          meta.keywords(
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (BuildContext context, GoRouterState state) =>
              const ProductAllCategoryPage(
                  category:
                      'All Products'), // Parameter category bisa disesuaikan
        ),
        GoRoute(
